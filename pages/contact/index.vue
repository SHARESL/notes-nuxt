<template>
  <div class="p-contact">
    ...
    <div class="p-contact__inner">
      <client-only>
        <validation-observer ref="observer" v-slot="{ invalid, validated }" tag="form" class="c-contact__form" name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" @submit.prevent="onSubmit" :class="sendingClass">
            ...
            <div class="c-contact__content">
              <validation-provider v-slot="{ errors }" rules="required|max:100" name="お名前">
                ...
                <transition name="error">
                  <p v-show="errors.length" class="c-contact__error">{{ errors[0] }}</p>
                </transition>
              </validation-provider>
            </div>
            <!-- /.c-contact__content -->
          ...
          <!-- /.c-contact__item -->
          <div class="c-contact__item" v-show="false">
            <div class="c-contact__label">
          ...
          <!-- /.c-contact__item -->
          <div class="c-contact__item c-contact__item--submit">
            <button class="c-contact__btn c-btn" type="submit" :disabled="invalid || !validated">送信</button>
          </div>
          <!-- /.c-contact__item -->
        </validation-observer>
        <!-- /.c-contact__form -->
